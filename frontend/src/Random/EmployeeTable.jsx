...
function EmployeeTable({
    ...
    const headers = ['Image','Name', 'Email', 'Phone', 'Department', 'Actions'];
    ...
    const TableRow = ({ employee }) => {
        return <tr>
            <td>
                    <img
                        src={employee.profileImage || 'https://www.shutterstock.com/image-vector/user-profile-icon-vector-avatar-600nw-2247726673.jpg'} // Fallback to a default image if profileImage is null
                        alt={employee.name}
                        className="img-fluid"
                        style={{ width: '50px', height: '50px', objectFit: 'cover' }} // Adjust the size
                    />
            </td>
            <td>
